...
python3.10 -V ;
pip3.10 -V;
sudo dnf install openjdk-11-jdk
...
else echo "FAILED TO INSTALL Development tools, make sure your are either using apt(ubuntu) or dnf(fedora) as a package manager">&2; fi